...
int main() {
    ...
    for (int i = 0; i < 5; i++) { 
        ...
        for (int k = 0; k < n; k++) {
            if (k % 2 == 0) {
                sum_pos += 1.0 / (2.0 * k + 1.0);           // Se suman los terminos positivos
            }
        }
        ...
        for (int k = 0; k < n; k++) {
            if (k % 2 != 0) {
                sum_neg += 1.0 / (2.0 * k + 1.0);           // Se suman los terminos negativos
            }
        }

        double sum = sum_pos - sum_neg;                     // Se restan los resultados
        pi_approx = 4.0 * sum;                              // Se multiplica por 4
